...
import {RadioSizeCheck} from '../../constant/validate';
import ModalSuccess from '../../component/modal/ModalSuccess';
import RenderRadio from './../../component/radio-circle/renderRadios';

const dataSize = [
  {Id: 1, Value: 'M', Title: 'M'},
  {Id: 2, Value: 'L', Title: 'L'},
  {Id: 3, Value: 'XL', Title: 'XL'},
];
        ...
        <ModalSuccess
          modal={
            <View style={[styles.ModalSuccess]}>
              ...
              />
              <Text
                style={{fontSize: 14, color: color.black, fontWeight: '600'}}>
      ...
      <View style={[styles.container]}>
        ...
        <ScrollView
          ...
          <View style={[styles.main]}>
            ...
            <Text
              style={{fontSize: 17, fontWeight: '400', color: color.active}}>
              500.000
              <Text
            ...
            <View style={[styles.choiceSize]}>
              ...
              <View>
                <Text style={[styles.des]}>
                  ...
                  xụp tại một hàng phở bình dân. Nguyên liệu chính đơn giản gồm
                  có nước dùng đậm đà, bánh phở tươi, một chút rau thơm và thịt
                  gà hoặc thịt bò. Món ăn này ngon, rẻ và bạn muốn ăn bất kỳ giờ
                  nào trong ngày cũng có..
                </Text>
              </View>
            </View>
            <View
...
export default reduxForm({form: 'ProductCardDetailForm'})(CardDetail);
